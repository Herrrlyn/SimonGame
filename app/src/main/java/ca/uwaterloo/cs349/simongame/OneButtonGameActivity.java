...
public class OneButtonGameActivity extends AppCompatActivity implements Observer, View.OnClickListener {

    simonModel Simon;
    Button One_1,  One_begin, One_Submit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_one_button_game);

        Simon = simonModel.getInstance();
        Simon.setNumButtons(1);


        One_1 = findViewById(R.id.oneButt);
        One_begin = findViewById(R.id.oneBegin);
        One_Submit = findViewById(R.id.oneSubmit);

        scoreNum = findViewById(R.id.oneScore);
        message = findViewById(R.id.oneMessage);
        Simon.addObserver(this);

        One_begin.setOnClickListener(new View.OnClickListener() {
        ...
        //while (Simon.getState() == simonModel.State.COMPUTER) {
        One_1.setOnClickListener(this);



        One_Submit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                //message = (TextView) v.getRootView().findViewById(R.id.fourMessage);
                if (correct) {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.oneButt:
                if (!Simon.verifyButton(buttToInteger(One_1))) {
